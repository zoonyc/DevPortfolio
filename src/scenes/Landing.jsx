  ...
  {isAboveLarge ? (
    ...
    >
      <img
        ...
        z-10 w-full max-w-[400px] md:max-w-[600px] rounded-t-[400px]"
      />
    </div>
  ) : (
    <img
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            I'm Javier, a Mechatronics Engineer with experience in process automation using RPA, 
            database management, and systems analysis. Committed to delivering efficient solutions and high-quality software, 
            with a strong interest in continuous professional growth within the field of information technology.
          </p>
        </motion.div>
